...
namespace Xabe.FFmpeg
{
    ...
    ///     (ffprobe output). Produces a <see cref="JsonValue"/> tree. Structural failures surface
    ///     as <see cref="InvalidDataException"/> with the originating parser exception as
