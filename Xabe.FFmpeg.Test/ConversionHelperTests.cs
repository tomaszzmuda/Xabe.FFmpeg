...
namespace Xabe.FFmpeg.Test
{
...

    {
        ...
        public async Task ToGifTest(int loopCount, int delay)
        {
            ...
            ConversionResult result = await Conversion.ToGif(Resources.Mp4, output, loopCount, delay)
                                          .Execute();
        ...
        public async Task JoinWith(string firstFile, string secondFile, int duration, int width, int height)
        {
            ...
            ConversionResult result = await ConversionHelper.Concatenate(output, firstFile, secondFile);
        ...
        public async Task AddAudio()
        {
            ...
            ConversionResult result = await Conversion.AddAudio(Resources.Mp4, Resources.Mp3, output)
                                          .Execute();
        ...
        public async Task AddSubtitleTest()
        {
            ...
            ConversionResult result = await Conversion.AddSubtitle(input, output, Resources.SubtitleSrt)
                                          .Execute();
        ...
        public async Task AddSubtitleWithLangTest()
        {
            ...
            var language = "pol";
            ConversionResult result = await Conversion.AddSubtitle(input, output, Resources.SubtitleSrt, language)
                                          .Execute();
        ...
        public async Task BurnSubtitleTest()
        {
            ...
            ConversionResult result = await Conversion.AddSubtitles(input, output, Resources.SubtitleSrt)
                                          .Execute();
        ...
        public async Task ChangeSizeTest()
        {
            ...
            ConversionResult result = await Conversion.ChangeSize(input, output, new VideoSize(640, 360))
                                          .Execute();
        ...
        public async Task ExtractAudio()
        {
            ...
            ConversionResult result = await Conversion.ExtractAudio(Resources.Mp4WithAudio, output)
                                          .Execute();
        ...
        public async Task ExtractVideo()
        {
            ...
            ConversionResult result = await Conversion.ExtractVideo(Resources.Mp4WithAudio, output)
                                          .Execute();
        ...
        {
            string output = Path.Combine(Path.GetTempPath(), Guid.NewGuid() + FileExtensions.Png);
            ConversionResult result = await Conversion.Snapshot(Resources.Mp4WithAudio, output, TimeSpan.FromSeconds(0))
                                          .Execute();
        ...
        {
            string output = Path.ChangeExtension(Path.GetTempFileName(), FileExtensions.Mp4);
            ConversionResult result = await Conversion.Split(Resources.Mp4WithAudio, output, TimeSpan.FromSeconds(2), TimeSpan.FromSeconds(8))
                                          .Execute();
        ...
        public async Task ToMp4Test()
        {
            ...
            ConversionResult result = await Conversion.ToMp4(Resources.MkvWithAudio, output)
                                          .Execute();
        ...
        public async Task ToOgvTest()
        {
            ...
            ConversionResult result = await Conversion.ToOgv(Resources.MkvWithAudio, output)
                                          .Execute();
        ...
        public async Task ToTsTest()
        {
            ...
            ConversionResult result = await Conversion.ToTs(Resources.Mp4WithAudio, output)
                                          .Execute();
        ...
        public async Task ToWebMTest()
        {
            ...
            ConversionResult result = await Conversion.ToWebM(Resources.Mp4WithAudio, output)
                                          .Execute();
        ...
        {
            string output = Path.ChangeExtension(Path.GetTempFileName(), FileExtensions.Mp4);
            ConversionResult result = await Conversion.SetWatermark(Resources.Mp4WithAudio, output, Resources.PngSample, Position.Center)
                                          .Execute();
